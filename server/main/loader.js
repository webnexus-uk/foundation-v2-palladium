...
const Loader = function (logger, configMain) {
  ...
  this.handleConfigs = function () {
    ...
    if (fs.existsSync(normalizedPath + "palladium.js")) {
      config = require(normalizedPath + "palladium.js");
      ...
      throw new Error(
        "Unable to find palladium.js file. Read the installation/setup instructions"
      );
    }
    return config;
  };
