  ...
  switch (type) {
    case "pubkey":
      return exports.encodeChunks([
        exports.getPalladiumOPCodes("OP_DUP"),
        exports.getPalladiumOPCodes("OP_HASH160"),
        address,
        exports.getPalladiumOPCodes("OP_EQUALVERIFY"),
        exports.getPalladiumOPCodes("OP_CHECKSIG"),
      ]);
    case "script":
      return exports.encodeChunks([
        exports.getPalladiumOPCodes("OP_HASH160"),
        address,
        exports.getPalladiumOPCodes("OP_EQUAL"),
      ]);
    case "witnesspubkey":
      return exports.encodeChunks([
        exports.getPalladiumOPCodes("OP_0"),
        address,
      ]);
    case "witnessscript":
      return exports.encodeChunks([
...
exports.encodeBuffer = function (buffer, number, offset) {
  ...
  if (size === 1) {
    ...
    buffer.writeUInt8(exports.getPalladiumOPCodes("OP_PUSHDATA1"), offset);
    buffer.writeUInt8(number, offset + 1);
  } else if (size === 3) {
    buffer.writeUInt8(exports.getPalladiumOPCodes("OP_PUSHDATA2"), offset);
    buffer.writeUInt16LE(number, offset + 1);
  } else {
    buffer.writeUInt8(exports.getPalladiumOPCodes("OP_PUSHDATA4"), offset);
...
// https://github.com/p2pool/p2pool/blob/53c438bbada06b9d4a9a465bc13f7694a7a322b7/p2pool/palladium/data.py#L218
...
exports.getPalladiumOPCodes = function (type) {
  switch (type) {
    case "OP_0":
      return 0;
    case "OP_PUSHDATA1":
...
exports.getEncodingLength = function (data) {
  return data < exports.getPalladiumOPCodes("OP_PUSHDATA1")
    ? 1
    : data <= 0xff
    ? 2
    : data <= 0xffff
...
exports.getMinimalOPCodes = function (buffer) {
  if (buffer.length === 0) return exports.getPalladiumOPCodes("OP_0");
  if (buffer.length !== 1) return;
  if (buffer[0] >= 1 && buffer[0] <= 16) {
    return exports.getPalladiumOPCodes("OP_RESERVED") + buffer[0];
  }
  if (buffer[0] === 0x81) return exports.getPalladiumOPCodes("OP_1NEGATE");
};
